...
2. Légère modification du format des cartes et de celui des messages d'erreurs affichés *comme figures*
3. Pour des raisons d'environnement de travail local (= Windows sans accès au sous-système Linux), les versions des bibliothèques plotly et kaleido ont dû être modifiées à la fois pour *dibisoplot* et *dibisoreporting*. La configuration suivante fonctionne sans dommage apparent : 
- plotly 6.3.1
- kaleido 1.2.0 
- openalex-analysis 0.15.2, malgré une erreur de compatibilité avec cette version de kaleido, sans conséquence notable.  
Les fichiers requirements.txt et pyproject.toml ont été mis à jour en conséquence.

## TO DO

- [ ] dé-LaTeXiser les messages d'erreurs *passim* 
- [ ] dé-LaTeXiser pubpart
- [ ] dé-LaTeXiser la biblio ?
